# Generated by Django 2.0.3 on 2018-03-26 11:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Board',
            fields=[
                ('id_board', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='CardLog',
            fields=[
                ('id_card_log', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='CardPriority',
            fields=[
                ('id_card_priority', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Column',
            fields=[
                ('id_column', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_column_permissions', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='DeleteReason',
            fields=[
                ('id_delete_reason', models.IntegerField(primary_key=True, serialize=False)),
                ('description', models.CharField(max_length=1024)),
            ],
        ),
        migrations.CreateModel(
            name='DeveloperGroup',
            fields=[
                ('id_developer_group', models.IntegerField(primary_key=True, serialize=False)),
                ('title', models.CharField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id_developer_group_membership', models.IntegerField(primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField()),
        ...
        migrations.CreateModel(
            name='GroupRole',
            fields=[
                ('id_group_role', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_project', models.CharField(max_length=500)),
        ...
        migrations.CreateModel(
            name='WipViolation',
            fields=[
                ('id_wip_violation', models.IntegerField(primary_key=True, serialize=False)),
                ('date', models.DateTimeField()),
                ('id_card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.Card')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_wip_violation_reason', models.IntegerField(primary_key=True, serialize=False)),
